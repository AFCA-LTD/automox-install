...
param (
    ...
    [String]$AccessKey = "8cd1cdfe-fa88-4ce3-91f7-70ace5802b18",
...
$installerUrl = "https://console.automox.com/Automox_Installer-latest.msi"
...
function Install-AxAgent {
    ...
    $process = Start-Process 'msiexec.exe' -ArgumentList "/i `"$installerPath`" /qn /norestart ACCESSKEY=8cd1cdfe-fa88-4ce3-91f7-70ace5802b18" -Wait -PassThru
...
if (!$download) {
    ...
    Exit 1
} else { Write-Log "Download succeeded" $logFile }
